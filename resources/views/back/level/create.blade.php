      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <form action="{{ url('level') }}" method="post">
            ...
            <input type="text" class="form-control" name="pengerjaan" id="pengerjaan" placeholder="Masukan Pengerjaan" required />
            </div>

             <div>
            <label class="form-label" for="perbaikan">Perbaikan</label>
            <input type="text" class="form-control" name="perbaikan" id="perbaikan" placeholder="Masukan Perbaikan" required />
            </div>

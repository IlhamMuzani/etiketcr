          ...
          <form action="{{ url('level/' . $level->id) }}" method="post">
            ...
            @method('put')
             ...
             <div class="mb-3">
              ...
              <input type="text" class="form-control @error('pengerjaan') is-invalid @enderror" name="pengerjaan" id="pengerjaan"
                placeholder="Masukan pengerjaan" value="{{ old('pengerjaan', $level->pengerjaan) }}" autofocus />
              @error('pengerjaan')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
              ...
              <input type="text" class="form-control @error('perbaikan') is-invalid @enderror" name="perbaikan" id="perbaikan"
                placeholder="Masukan perbaikan" value="{{ old('perbaikan', $level->perbaikan) }}" autofocus />
              @error('perbaikan')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
